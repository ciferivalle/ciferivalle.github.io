    ...
    if (this.props.data) {
      ...
      var award = this.props.data.awards.map(function(award) {
        return (
          <div key={award.name}>
            ...
            <p className="futura lime">
              {award.organizer}
              <span>&bull;</span> <em className="date">{award.date}</em>
            </p>
      ...
      var skills = this.props.data.skills.map(function(skills) {
        ...
        return (
          <ul>
            <li key={skills.name}>
              <p style={{ width: skills.level }} className={className}></p>
              <em>{skills.name}</em>
            </li>
          </ul>
        );
        ...
        <div class="container text-left">
          <div className="row">
            <div className="col-md-3">
              <h2>
                <span className="roboto boom">Education</span>
              </h2>
            </div>
          ...
          <div className="row work my-5">
            <div className="col-md-3">
              <h2>
                <span className="futura my-5 boom">Work Experience</span>
              </h2>
            </div>

            <div className="col-md-9">{work}</div>
          </div>
          ...
          <div className="row work my-5">
            <div className="col-md-3">
              <h2>
                <span className="futura my-5 boom">Award</span>
              </h2>
            </div>

            <div className="col-md-9">{award}</div>
          </div>
